...
export default {
  ...
  methods: {
    ...
    handleClick_compare(checked, value) {
      alert(value);
...
<template>
  <div class="about">
    ...
    <div class="select-wrapper">
      ...
      &emsp;
      <el-select-v2 v-model="select_1" :options="selections[0]" placeholder="Please select" @change="updateSelections(0)"
        size="large" />
      &ensp;
      <el-select-v2 v-model="select_2" :options="selections[1]" placeholder="Please select" @change="updateSelections(1)"
        size="large" :disabled="!select_1" />
      &ensp;
      <el-select-v2 v-model="select_3" :options="selections[2]" placeholder="Please select" @change="updateSelections(2)"
        size="large" :disabled="!select_2" />
      &ensp;
      <el-button @click="sendSelections" color="#626aef" :disabled="!select_3">
        确定
      </el-button>
    </div>
    ...
    <div class="details_and_compare">
      ...
      <div v-if="url" class="details">
        <div class="image">
          <el-image style="width: 200px; height: 200px" :src="url" :zoom-rate="1.2" :preview-src-list="srcList"
      ...
      <div v-if="setting_compare.is_open" class="compare">
        ...
        <el-scrollbar>
          <div style="display: flex;">
            <el-card v-for="(point, index) in setting_compare.points" :key="index" :body-style="{ padding: '0px' }"
              class="compare_card">
              <a>NO. {{ index + 1 }}</a>
              <div class="compare_image">
                <el-image style="width: 200px; height: 200px" :src="point.url" :zoom-rate="1.2"
                  :preview-src-list="point.srcList" :initial-index="4" fit="cover" />
              </div>
